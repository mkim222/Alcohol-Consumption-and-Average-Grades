...
alcohol_grade <- student_mat_revised_5 %>% 
  ggplot()+
  geom_smooth(mapping = aes(x = alcohol, y = grade), method = lm, se = FALSE, size = 2, color = "blue")
...
alcohol_studytime <- student_mat_revised_5 %>% 
  ggplot()+
  geom_smooth(mapping = aes(x = alcohol, y = studytime), method = lm, se = FALSE, size = 2, color = "blue")
